...
const createOrder = async (req, res) => {
  try {
    ...
    const create_payment_json = {
      ...
      redirect_urls: {
        return_url: "https://trenzo-backend.onrender.com/shop/paypal-return",
        cancel_url: "https://trenzo-backend.onrender.com/shop/paypal-cancel",
      },
      transactions: [
        {
          item_list: {
...
const capturePayment = async (req, res) => {
  try {
    ...
    // ✅ Step 1: Execute the PayPal payment
